...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBWanE9j0EMM2GNtJDVCnsKMVCLJvXhf44';    // 'AIzaSyDn5L11W2b1gs8RXYIhZe_8XPPpT9Mjc0g'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $https						= TRUE; // chang 2					// If set to TRUE will load the Google Maps JavaScript API over HTTPS, allowing you to utilize the API within your HTTPS secure application 
	...
	var $sensor						= TRUE;	//change				// Set to TRUE if being used on a device that can detect a users location
